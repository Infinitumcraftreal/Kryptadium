...
public class KryptaxoEntity extends AxolotlEntity implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public KryptaxoEntity(EntityType<? extends AxolotlEntity> entityType, World world) {
    ...
    @Nullable
    @Override
    public AxolotlEntity createChild(ServerWorld world, PassiveEntity entity) {
